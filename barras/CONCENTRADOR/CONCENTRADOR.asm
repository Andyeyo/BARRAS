...
;CONCENTRADOR.c,184 :: 		SUart0_write('\n');  //add PC
	...
	MOVWF       FARG_SUart0_Write_tch+0 
	CALL        _SUart0_Write+0, 0
;CONCENTRADOR.c,187 :: 		for(u=0;u<36;u++)
	CLRF        _u+0 
L_main29:
	MOVLW       36
	SUBWF       _u+0, 0 
	BTFSC       STATUS+0, 0 
	GOTO        L_main30
;CONCENTRADOR.c,189 :: 		Suart2_write((char)buffer[u]); //transmitir por RS232 puerto J2(RJ45) pc
	MOVLW       _buffer+0
	MOVWF       FSR0 
	MOVLW       hi_addr(_buffer+0)
	MOVWF       FSR0H 
...
;CONCENTRADOR.c,190 :: 		}
	GOTO        L_main29
L_main30:
;CONCENTRADOR.c,193 :: 		if(id_slave == 10)
	MOVF        _id_slave+0, 0 
	XORLW       10
	BTFSS       STATUS+0, 2 
	GOTO        L_main32
;CONCENTRADOR.c,195 :: 		for(u=3;u<10;u++){ ee1[11+u]=s_entran[u]; }
	MOVLW       3
	MOVWF       _u+0 
L_main33:
	MOVLW       10
...
;CONCENTRADOR.c,196 :: 		}
L_main32:
;CONCENTRADOR.c,197 :: 		if(id_slave == 20)
	MOVF        _id_slave+0, 0 
	XORLW       20
	BTFSS       STATUS+0, 2 
	GOTO        L_main36
;CONCENTRADOR.c,199 :: 		for(u=3;u<10;u++){ ee2[11+u]=s_entran[u]; }
	MOVLW       3
	MOVWF       _u+0 
L_main37:
	MOVLW       10
...
;CONCENTRADOR.c,200 :: 		}
L_main36:
;CONCENTRADOR.c,202 :: 		fbt=0; pbuffer=0;
	CLRF        _fbt+0 
	CLRF        _pbuffer+0 
;CONCENTRADOR.c,204 :: 		entran=0; salen=0; bloqueos=0;
	CLRF        _entran+0 
	CLRF        _entran+1 
	CLRF        _entran+2 
	CLRF        _entran+3 
...
;CONCENTRADOR.c,211 :: 		if(counter2>(140000*20))
	MOVF        _counter2+3, 0 
	SUBLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L__main51
...
L__main51:
	BTFSC       STATUS+0, 0 
	GOTO        L_main40
;CONCENTRADOR.c,213 :: 		counter2=0;
	CLRF        _counter2+0 
	CLRF        _counter2+1 
	CLRF        _counter2+2 
	CLRF        _counter2+3 
;CONCENTRADOR.c,214 :: 		if(ax==0)
	MOVF        _ax+0, 0 
	XORLW       0
	BTFSS       STATUS+0, 2 
	GOTO        L_main41
;CONCENTRADOR.c,216 :: 		ax=1;
	MOVLW       1
	MOVWF       _ax+0 
;CONCENTRADOR.c,217 :: 		}
	GOTO        L_main42
L_main41:
;CONCENTRADOR.c,220 :: 		ax=0;
	CLRF        _ax+0 
;CONCENTRADOR.c,221 :: 		}
L_main42:
;CONCENTRADOR.c,225 :: 		imprimirAlerta((esclavo/10)+48);
	MOVLW       10
	MOVWF       R4 
	MOVF        _esclavo+0, 0 
	MOVWF       R0 
	...
	MOVWF       FARG_imprimirAlerta_lugar+0 
	CALL        _imprimirAlerta+0, 0
;CONCENTRADOR.c,226 :: 		peticion(esclavo); //pedido de envio de información
	MOVF        _esclavo+0, 0 
	MOVWF       FARG_peticion_dirEsclavo+0 
	CALL        _peticion+0, 0
;CONCENTRADOR.c,227 :: 		esclavo += 10;
	MOVLW       10
	ADDWF       _esclavo+0, 0 
	MOVWF       R1 
	MOVF        R1, 0 
	MOVWF       _esclavo+0 
;CONCENTRADOR.c,228 :: 		if(esclavo > 30)
	MOVF        R1, 0 
	SUBLW       30
	BTFSC       STATUS+0, 0 
	GOTO        L_main43
;CONCENTRADOR.c,230 :: 		esclavo = 10;
	MOVLW       10
	MOVWF       _esclavo+0 
;CONCENTRADOR.c,231 :: 		}
L_main43:
